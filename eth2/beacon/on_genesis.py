...
from eth2.beacon.typing import Gwei, Slot, Timestamp, ValidatorIndex
...
def get_genesis_block(
    genesis_state_root: Hash32, genesis_slot: Slot, block_class: Type[BaseBeaconBlock]
) -> BaseBeaconBlock:
