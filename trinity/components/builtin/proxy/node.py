...
from .infura import InfuraHeaderDB
from .server import RequestHandler


class ProxyNode(Node[ETHPeer]):
    ...
    def get_event_server(self) -> PeerPoolEventServer[ETHPeer]:
        ...
        if self._event_server is None:
            self._event_server = RequestHandler(self.get_peer_pool(), self.headerdb)
