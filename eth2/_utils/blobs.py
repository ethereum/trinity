...
from eth_utils import apply_to_return_value, int_to_big_endian, ValidationError

from eth._utils.padding import zpad_right
from eth2._utils.merkle.normal import get_merkle_root_from_items
