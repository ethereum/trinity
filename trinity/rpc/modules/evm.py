...
from eth.tools.fixtures import apply_fixture_block_to_chain, new_chain_from_fixture

from trinity.rpc.format import format_params
from trinity.rpc.modules import ChainReplacementEvent, Eth1ChainRPCModule
...
class EVM(Eth1ChainRPCModule):
    ...
    async def resetToGenesisFixture(self, chain_info: Any) -> BaseChain:
        ...
        self.event_bus.broadcast(
            ChainReplacementEvent(chain), BroadcastConfig(internal=True)
        )
