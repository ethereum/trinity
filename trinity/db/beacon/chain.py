...
class BaseAsyncBeaconChainDB(ABC):
    ...
    @abstractmethod
    async def coro_get_canonical_head(
        self, block_class: Type[BaseBeaconBlock]
    ) -> BaseBeaconBlock:
        pass
    ...
    @abstractmethod
    async def coro_get_finalized_head(
        self, block_class: Type[BaseBeaconBlock]
    ) -> BaseBeaconBlock:
        pass

    @abstractmethod
    async def coro_get_block_by_root(
    ...
    @abstractmethod
    async def coro_persist_state(self, state: BeaconState) -> None:
        pass
...
class AsyncBeaconChainDBPreProxy(BaseAsyncBeaconChainDB):
    ...
    coro_get_canonical_block_root_by_slot = async_method(
