...
from trinity._utils.eip1085 import Account, extract_genesis_state


ADDRESS = b"01" * 10
ADDRESS_HEX = encode_hex(ADDRESS)

ACCOUNT_EMPTY = {"balance": "0x00", "nonce": "0x00", "code": "", "storage": {}}
N_ACCOUNT_EMPTY = Account(**{"balance": 0, "nonce": 0, "code": b"", "storage": {}})
...
N_ACCOUNT_SIMPLE = Account(
    **{"balance": 16, "nonce": 32, "code": b"test", "storage": {}}
)
...
N_ACCOUNT_STORAGE = Account(
    **{"balance": 16, "nonce": 32, "code": b"", "storage": {1: 1952805748}}
)
