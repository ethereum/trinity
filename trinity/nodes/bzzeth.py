...
from trinity.server import BZZETHServer

from .base import Node


class BZZETHNode(Node):
    _chain: FullChain = None
    _p2p_server: BZZETHServer = None
    ...
    def get_p2p_server(self) -> BZZETHServer:
        if self._p2p_server is None:
            manager = self.db_manager
            self._p2p_server = BZZETHServer(
