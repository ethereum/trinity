...
async def test_packet_decoder():
    ...
    packet_decoder = PacketDecoder(datagram_receive_channel, packet_send_channel)
    async with background_trio_service(packet_decoder):
...
async def test_packet_encoder():
    ...
    packet_encoder = PacketEncoder(packet_receive_channel, datagram_send_channel)
    async with background_trio_service(packet_encoder):
