...
from eth2.beacon._utils.random import get_permuted_index, shuffle
...
@pytest.mark.parametrize(
    ("values", "seed", "shuffle_round_count"),
    [
        (tuple(range(12)), b"\x23" * 32, 90),
        (tuple(range(2 ** 6))[10:], b"\x67" * 32, 20),
    ],
)
