...
_KEYTYPE = _descriptor.EnumDescriptor(
    ...
    values=[
        _descriptor.EnumValueDescriptor(
            name="RSA", index=0, number=0, options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="Ed25519", index=1, number=1, options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="Secp256k1", index=2, number=2, options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="ECDSA", index=3, number=3, options=None, type=None
        ),
    ],
...
_PUBLICKEY = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="Type",
            full_name="crypto.pb.PublicKey.Type",
            index=0,
            number=1,
            type=14,
            cpp_type=8,
...
_PRIVATEKEY = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="Type",
            full_name="crypto.pb.PrivateKey.Type",
            index=0,
            number=1,
            type=14,
            cpp_type=8,
