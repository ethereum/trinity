...
@pytest.mark.parametrize(("slashed", "success"), [(False, True), (True, False)])
def test_validate_proposer_slashing_is_slashed(
    slots_per_epoch, genesis_state, beacon_chain_shard_number, keymap, slashed, success
):
    # Invalid
    if success:
