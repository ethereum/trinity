...
from trinity.protocol.bcc.commands import GetBeaconBlocksMessage, BeaconBlocksMessage


class BeaconBlocksExchange(
    BaseExchange[
        GetBeaconBlocksMessage, BeaconBlocksMessage, Tuple[BaseBeaconBlock, ...]
    ]
):
