...
from trinity.bootstrap import kill_trinity_gracefully, main_entry
from trinity.config import TrinityConfig, BeaconAppConfig
from trinity.constants import APP_IDENTIFIER_BEACON
from trinity.db.beacon.manager import create_db_server_manager
from trinity.endpoint import TrinityMainEventBusEndpoint
from trinity.events import ShutdownRequest
from trinity.extensibility import PluginManager
from trinity.initialization import ensure_beacon_dirs
from trinity.plugins.registry import BASE_PLUGINS
...
def trinity_boot(
    ...
    def kill_trinity_with_reason(reason: str) -> None:
        kill_trinity_gracefully(
            trinity_config, logger, (), plugin_manager, main_endpoint, reason=reason
        )
