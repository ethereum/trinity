...
from eth2.beacon.typing import HashTreeRoot, Slot, Epoch
...
class Status(HashableContainer):
    ...
    def create(
        ...
        finalized_root: HashTreeRoot = ZERO_HASH_TREE_ROOT,
...
class BeaconBlocksByRootRequest(HashableContainer):
    ...
    @classmethod
    def create(cls, block_roots: Sequence[HashTreeRoot]) -> "BeaconBlocksByRootRequest":
