...
from p2p.auth import HandshakeInitiator, HandshakeResponder
...
from tests.p2p.auth_constants import eip8_values, test_values
...
async def test_handshake():
    ...
    assert (
        _auth_init[65:] == test_values["auth_plaintext"][65:]
