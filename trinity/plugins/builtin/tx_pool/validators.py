...
class DefaultTransactionValidator:
    ...
    def __init__(
        self, chain: BaseChain, initial_tx_validation_block_number: BlockNumber = None
    ) -> None:
        ...
        self._ordered_tx_classes = [
            vm_class.get_transaction_class() for _, vm_class in self.vm_configuration
        ]
        ...
        self._initial_tx_class_index = self._ordered_tx_classes.index(
            self._initial_tx_class
        )
    ...
    def _get_tx_class_for_block_number(
