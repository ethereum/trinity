...
@to_tuple
def initialize_eth1_modules(
    chain: BaseAsyncChain, event_bus: TrinityEventBusEndpoint
) -> Iterable[BaseRPCModule]:
...
@to_tuple
def initialize_beacon_modules(
    chain: Any, event_bus: TrinityEventBusEndpoint
) -> Iterable[BaseRPCModule]:
