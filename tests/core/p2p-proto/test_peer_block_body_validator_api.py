...
from eth_utils import big_endian_to_int, keccak, to_tuple
...
@pytest.mark.asyncio
async def test_eth_peer_get_block_bodies_round_trip_with_empty_response(
    eth_peer_and_remote
):
...
@pytest.mark.asyncio
async def test_eth_peer_get_block_bodies_round_trip_with_full_response(
    eth_peer_and_remote
):
    peer, remote = eth_peer_and_remote
...
@pytest.mark.asyncio
async def test_eth_peer_get_block_bodies_round_trip_with_partial_response(
    eth_peer_and_remote
):
    peer, remote = eth_peer_and_remote
...
@pytest.mark.asyncio
async def test_eth_peer_get_block_bodies_round_trip_no_match_invalid_response(
    eth_peer_and_remote
):
    peer, remote = eth_peer_and_remote
