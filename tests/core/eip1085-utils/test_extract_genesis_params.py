...
from eth_utils import to_int, to_hex, to_bytes, to_canonical_address
from eth_utils.curried import hexstr_if_str
from eth_utils.toolz import merge, valmap

from trinity._utils.eip1085 import GenesisParams, extract_genesis_params
...
def _mk_raw_params(**kwargs):
    return {"genesis": merge(PARAMS_DEFAULTS, valmap(hexstr_if_str(to_hex), kwargs))}
